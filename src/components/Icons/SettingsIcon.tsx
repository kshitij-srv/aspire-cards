const SettingsIcon = ({ className = "w-6 h-6 text-white" }: { className?: string }) => (
    <svg
    ...
    >
        <g transform="translate(-2 4)">
            <rect width="24" height="24" transform="translate(2 -4)" fill="none" opacity="0.001" />
            <g transform="translate(4 -4)">
                <path
                    d="M92.817,11.547a5.6,5.6,0,0,0,4.091-1.691A5.58,5.58,0,0,0,98.6,5.773a5.581,5.581,0,0,0-1.7-4.082,5.793,5.793,0,0,0-8.181,0,5.581,5.581,0,0,0-1.7,4.082,5.58,5.58,0,0,0,1.7,4.082A5.605,5.605,0,0,0,92.817,11.547Z"
